"""
昆仑创作引擎 — 提示词管理路由
/prompts/{book_id}, /prompts/{book_id}/{agent}
"""
...
@router.get("/prompts/{book_id}", summary="列出所有可自定义的提示词状态")
...
@router.get("/prompts/{book_id}/{agent}", summary="获取指定提示词")
...
@router.post("/prompts/{book_id}/{agent}", summary="设置提示词（用户覆盖）")
...
@router.delete("/prompts/{book_id}/{agent}", summary="重置提示词为系统默认")

import{d as ee,h as c,b9 as ht,ba as gt,r as L,bb as ye,bc as xt,bd as Z,be as mt,a1 as yt,T as Pe,bf as wt,aI as St,F as Ct,a4 as Rt,bg as Tt,bh as zt,v as G,ae as $t,ab as r,an as i,ad as g,ac as z,az as Pt,b0 as ne,a3 as we,aP as oe,a7 as Wt,ag as We,bi as _t,am as Et,f as ie,n as se,D as Lt,bj as At,w as Bt,a8 as kt,bk as Se,aC as jt,ax as j,bl as J,bm as It,a_ as Ht,bn as Ot,b1 as Ft,ak as Dt,a9 as I,ai as Q}from"./index-wHqlCVHi.js";import{A as Mt}from"./Add-8a0AOq2B.js";const Nt=ye(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[ye("&::-webkit-scrollbar",{width:0,height:0})]),Vt=ee({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=L(null);function n(b){!(b.currentTarget.offsetWidth<b.currentTarget.scrollWidth)||b.deltaY===0||(b.currentTarget.scrollLeft+=b.deltaY+b.deltaX,b.preventDefault())}const l=ht();return Nt.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:gt,ssr:l}),Object.assign({selfRef:e,handleWheel:n},{scrollTo(...b){var x;(x=e.value)===null||x===void 0||x.scrollTo(...b)}})},render(){return c("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var Xt=/\s/;function Ut(e){for(var n=e.length;n--&&Xt.test(e.charAt(n)););return n}var Gt=/^\s+/;function Yt(e){return e&&e.slice(0,Ut(e)+1).replace(Gt,"")}var Ce=NaN,Kt=/^[-+]0x[0-9a-f]+$/i,qt=/^0b[01]+$/i,Jt=/^0o[0-7]+$/i,Qt=parseInt;function Re(e){if(typeof e=="number")return e;if(xt(e))return Ce;if(Z(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=Z(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=Yt(e);var l=qt.test(e);return l||Jt.test(e)?Qt(e.slice(2),l?2:8):Kt.test(e)?Ce:+e}var le=function(){return mt.Date.now()},Zt="Expected a function",ea=Math.max,ta=Math.min;function aa(e,n,l){var u,b,x,v,f,h,m=0,y=!1,T=!1,E=!0;if(typeof e!="function")throw new TypeError(Zt);n=Re(n)||0,Z(l)&&(y=!!l.leading,T="maxWait"in l,x=T?ea(Re(l.maxWait)||0,n):x,E="trailing"in l?!!l.trailing:E);function C(s){var _=u,F=b;return u=b=void 0,m=s,v=e.apply(F,_),v}function S(s){return m=s,f=setTimeout(W,n),y?C(s):v}function R(s){var _=s-h,F=s-m,D=n-_;return T?ta(D,x-F):D}function P(s){var _=s-h,F=s-m;return h===void 0||_>=n||_<0||T&&F>=x}function W(){var s=le();if(P(s))return $(s);f=setTimeout(W,R(s))}function $(s){return f=void 0,E&&u?C(s):(u=b=void 0,v)}function H(){f!==void 0&&clearTimeout(f),m=0,u=h=b=f=void 0}function k(){return f===void 0?v:$(le())}function p(){var s=le(),_=P(s);if(u=arguments,b=this,h=s,_){if(f===void 0)return S(h);if(T)return clearTimeout(f),f=setTimeout(W,n),C(h)}return f===void 0&&(f=setTimeout(W,n)),v}return p.cancel=H,p.flush=k,p}var ra="Expected a function";function na(e,n,l){var u=!0,b=!0;if(typeof e!="function")throw new TypeError(ra);return Z(l)&&(u="leading"in l?!!l.leading:u,b="trailing"in l?!!l.trailing:b),aa(e,n,{leading:u,maxWait:n,trailing:b})}const fe=yt("n-tabs"),_e={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},ba=ee({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:_e,slots:Object,setup(e){const n=Pe(fe,null);return n||wt("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:n.paneStyleRef,class:n.paneClassRef,mergedClsPrefix:n.mergedClsPrefixRef}},render(){return c("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),oa=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},$t(_e,["displayDirective"])),ce=ee({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:oa,setup(e){const{mergedClsPrefixRef:n,valueRef:l,typeRef:u,closableRef:b,tabStyleRef:x,addTabStyleRef:v,tabClassRef:f,addTabClassRef:h,tabChangeIdRef:m,onBeforeLeaveRef:y,triggerRef:T,handleAdd:E,activateTab:C,handleClose:S}=Pe(fe);return{trigger:T,mergedClosable:G(()=>{if(e.internalAddable)return!1;const{closable:R}=e;return R===void 0?b.value:R}),style:x,addStyle:v,tabClass:f,addTabClass:h,clsPrefix:n,value:l,type:u,handleClose(R){R.stopPropagation(),!e.disabled&&S(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){E();return}const{name:R}=e,P=++m.id;if(R!==l.value){const{value:W}=y;W?Promise.resolve(W(e.name,l.value)).then($=>{$&&m.id===P&&C(R)}):C(R)}}}},render(){const{internalAddable:e,clsPrefix:n,name:l,disabled:u,label:b,tab:x,value:v,mergedClosable:f,trigger:h,$slots:{default:m}}=this,y=b??x;return c("div",{class:`${n}-tabs-tab-wrapper`},this.internalLeftPadded?c("div",{class:`${n}-tabs-tab-pad`}):null,c("div",Object.assign({key:l,"data-name":l,"data-disabled":u?!0:void 0},St({class:[`${n}-tabs-tab`,v===l&&`${n}-tabs-tab--active`,u&&`${n}-tabs-tab--disabled`,f&&`${n}-tabs-tab--closable`,e&&`${n}-tabs-tab--addable`,e?this.addTabClass:this.tabClass],onClick:h==="click"?this.activateTab:void 0,onMouseenter:h==="hover"?this.activateTab:void 0,style:e?this.addStyle:this.style},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),c("span",{class:`${n}-tabs-tab__label`},e?c(Ct,null,c("div",{class:`${n}-tabs-tab__height-placeholder`}," "),c(Rt,{clsPrefix:n},{default:()=>c(Mt,null)})):m?m():typeof y=="object"?y:Tt(y??l)),f&&this.type==="card"?c(zt,{clsPrefix:n,class:`${n}-tabs-tab__close`,onClick:this.handleClose,disabled:u}):null))}}),ia=r("tabs",`

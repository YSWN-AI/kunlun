import{d as B,h as r,a4 as W,v as m,bY as A,bZ as j,a5 as q,b_ as O,b$ as G,aD as k,ad as z,ab as a,an as w,a7 as M,ag as T,c0 as L,a8 as X,ax as D}from"./index-wHqlCVHi.js";const Y={success:r(G,null),error:r(O,null),warning:r(q,null),info:r(j,null)},_=B({name:"ProgressCircle",props:{clsPrefix:{type:String,required:!0},status:{type:String,required:!0},strokeWidth:{type:Number,required:!0},fillColor:[String,Object],railColor:String,railStyle:[String,Object],percentage:{type:Number,default:0},offsetDegree:{type:Number,default:0},showIndicator:{type:Boolean,required:!0},indicatorTextColor:String,unit:String,viewBoxWidth:{type:Number,required:!0},gapDegree:{type:Number,required:!0},gapOffsetDegree:{type:Number,default:0}},setup(e,{slots:u}){const g=m(()=>{const o="gradient",{fillColor:t}=e;return typeof t=="object"?`${o}-${A(JSON.stringify(t))}`:o});function y(o,t,n,d){const{gapDegree:p,viewBoxWidth:f,strokeWidth:h}=e,l=50,b=0,s=l,i=0,x=2*l,$=50+h/2,v=`M ${$},${$} m ${b},${s}
      a ${l},${l} 0 1 1 ${i},${-x}

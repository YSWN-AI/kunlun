...
class TestAllImports:
    ...
    MODULES = [
        ...
        ("plot", "kunlun.plot", ["causal_chain_engine", "foreshadowing_manager", "conflict_engine"]),
        ("coherence", "kunlun.coherence", ["coherence_engine"]),
        ("worlds", "kunlun.worlds", ["WorldBuilder", "WorldAtlas", "FactionNetwork", "TimelineEngine"]),
    ]
...
class TestCharacterEngine:
    ...
    def test_arc_stage(self):
        ...
        arc = character_engine.arc_engine.get_current_stage(
            CharacterArcType.LEVEL_UP, 30, 200
        )
...
class TestPlotEngine:
    ...
    def test_causal_event(self):
        ...
        event = CausalEvent(
            event_id="test_evt_001", chapter_num=1, name="退婚",
            cause="慕家认为废灵根无价值",
            event="慕雪当众退婚",
            effect="林尘立下三年之约",
            decision="独闯青峰山",
            tension_level=4, is_turning_point=True,
        )
    ...
    def test_foreshadowing_plant(self):
        ...
        fs = ForeshadowingItem(
            foreshadow_id="test_fs_001", name="神秘玉佩",
            description="林尘母亲留下的玉佩，内含惊人秘密",
            planted_chapter=3, target_chapter=25,
        )
...
class TestCoherence:
    ...
    def test_tracked_item(self):
        ...
        item = TrackedItem(
            item_id="test_sword_001", name="星辰剑", category="item",
            current_state="完好在手", last_seen_chapter=1,
        )
